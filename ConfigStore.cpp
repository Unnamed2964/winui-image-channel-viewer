...
namespace
{
    ...
    [[noreturn]] void ThrowConfigError(std::filesystem::path const& configPath, std::wstring_view reason)
    {
    ...
    template<>
    uint32_t config_cast<uint32_t>(winrt::Windows::Data::Json::IJsonValue const& value)
    {
    ...
    template<>
    std::string config_cast<std::string>(winrt::Windows::Data::Json::IJsonValue const& value)
    {
    ...
    bool EnsureConfigDirectory(std::filesystem::path const& configPath)
    {
    ...
    bool WriteConfigFile(std::filesystem::path const& configPath, AppConfig const& config)
    {
    ...
    winrt::Windows::Data::Json::JsonObject MigrateConfigJsonToCurrent(
        winrt::Windows::Data::Json::JsonObject jsonObject,
        [[maybe_unused]] std::filesystem::path const& configPath)
    {
        return jsonObject;
    }

    uint32_t ReadConfigVersion(
